...
void RobotMap::init() {
	...
	containerElevatorlimitTop = new DigitalInput(pElevatorLimitTop);
	lw->AddSensor("ContainerElevator", "limitTop", containerElevatorlimitTop);
	
	containerElevatorlimitBottom = new DigitalInput(pElevatorLimitBottom);
	...
	containerElevatorelevatePot = new AnalogInput(pElevatorHeightPot); //TODO Get actual pot channel
