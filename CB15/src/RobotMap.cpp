...
Solenoid* RobotMap::strafeAxisSol1 = NULL;
Solenoid* RobotMap::strafeAxisSol2 = NULL;
...
void RobotMap::init() {
	...
	containerElevatorclawSol1 = new Solenoid(pClawSolenoid1A, pClawSolenoid1B);
	lw->AddActuator("ContainerElevator", "clawSol1", containerElevatorclawSol1);
	
	containerElevatorclawSol2 = new Solenoid(pClawSolenoid2A, pClawSolenoid2B);
	...
	toteElevatorlimitTop = new DigitalInput(pToteElevatorLimitBottom);
	lw->AddSensor("ToteElevator", "limitTop", toteElevatorlimitTop);

	strafeAxisSol1 = new Solenoid(pStrafeSolenoid1A, pStrafeSolenoid1B);
	lw->AddActuator("Chassis", "strafeAxisSol1", strafeAxisSol1);

	strafeAxisSol1 = new Solenoid(pStrafeSolenoid2A, pStrafeSolenoid2B);
	lw->AddActuator("Chassis", "strafeAxisSol2", strafeAxisSol2);
}
