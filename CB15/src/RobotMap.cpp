...
Encoder* RobotMap::containerElevatorpivotEn = NULL;
...
void RobotMap::init() {
	...
	containerElevatorpivotEn = new Encoder(8, 9, false, Encoder::k4X);
	lw->AddSensor("ContainerElevator", "pivotEn", containerElevatorpivotEn);
	containerElevatorpivotEn->SetDistancePerPulse(1.0);
        containerElevatorpivotEn->SetPIDSourceParameter(Encoder::kRate);
