...
//	setPoints = {3500, 3400, 3050, 2670, 2305, 1940, 1700};
	point=0;
	spdVal=0;
}
...
void ToteElevator::DriveSetPoint()
{
	//Upper and lower limits of array
	if(point<0)
	{
		point=0;
	}
	...
	//Set speed of motor, used in "../Commands/Drive.cpp"
	//Speed is mainly controlled by the constant, negate to change direction
	spdVal=-.005*(setPoints[point]-Robot::toteElevator->totePot->GetValue());
}
